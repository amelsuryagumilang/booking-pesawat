...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>admin_con/dashboard" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($menu == 'tampildata') {echo "active";} ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Tambah</a></li>
